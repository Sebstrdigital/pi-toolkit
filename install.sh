...
#   2. Installs pi-chains and pi-ui into pi via `pi install <abs-path>`
#   3. Builds and links CLI packages like pi-team-lean
#
...
TEAM_LEAN_SRC="$REPO_ROOT/pi-team-lean"
...
install_cli_package "pi-team-lean" "$TEAM_LEAN_SRC"
